...
###################################################################################
###
### purpose: This code is used to define Department of Health Care Access and Information (HCAI) ICD-9 and ICD-10 to diagnostic codes for 
### used to estimate effects of heat on emergency department visits in California at ZIP code-level. 
###  
